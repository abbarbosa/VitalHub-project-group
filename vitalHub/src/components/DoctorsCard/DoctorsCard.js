...
export const DoctorsCard = ({ id, nome, image, especialidade, selected, onPress, medico }) => {
  return (
    <TouchableOpacity onPress={() => onPress(id)}>
      <ContainerCardList style={{ borderWidth: selected ? 2 : 0, borderColor: '#496BBA' }}>
        ...
        <DoctorCardImage source={{ uri: 'https://images.tcdn.com.br/img/img_prod/1050053/dr_hans_chucrutes_19_1_6c8e017aaca4306cfc68b17052ba77cd.jpg' }} />
